...
const sayHello = () => {
  axios
  .get("http://localhost:3000/say-hello")
  .then((res) => {
...
const repeatMyParam = () => {
     axios
    .get(`http://localhost:3000/repeat/Aword`)
    .then((res) => {
...
const repBtn = document.querySelector('#repeat-button')
...
function newQuery (){
    axios
    .get('http://localhost:3000/query-test?myquery=Fool-Of-A-Took&query2=Gandalf-Outburst')
    .then((res) => {
        console.log(res.data)
    })
}
const qBtn = document.querySelector('#query-button')
qBtn.addEventListener("click", newQuery)
////////////////
//INTERMEDIATE//
////////////////
